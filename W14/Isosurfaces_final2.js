function Isosurfaces2( volume, isovalue, r, g, b )
{
    var geometry = new THREE.Geometry();
    var material = new THREE.MeshLambertMaterial();

   
    var color_hexadecimal = [];

    var R = parseInt(r) / 255.0;
    var G = parseInt(g) / 255.0;
    var B = parseInt(b) / 255.0;
    var color = new THREE.Color( R, G, B);
    color_hexadecimal .push([ '0x' + color.getHexString() ]);
    //console.log(color_hexadecimal[0] );
    ...
    material.color = new THREE.Color().setHex(color_hexadecimal[0]);
